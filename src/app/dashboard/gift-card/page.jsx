  ...
  return (
    <div className='px-6 py-12 min-h-screen bg-gray-100 text-center md:text-start'>
      ...
      <div className='flex flex-col gap-4 mt-5'>
        <div onClick={()=>route.push("/dashboard/gift-card/buy")} className='bg-white cursor-pointer md:max-w-[600px] p-4 rounded-lg shadow-md flex items-center justify-center flex-col'>
      ...
      <div onClick={()=>route.push("/dashboard/gift-card/sell")} className='bg-white cursor-pointer md:max-w-[600px] p-4 rounded-lg shadow-md flex items-center justify-center flex-col'>
