    ...
    <footer className="bg-gradient-to-r from-blue-500 to-green-400 z-70">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex justify-center space-x-6">
          ...
          <a href="https://x.com" className="text-white hover:text-blue-100" target="_blank" rel="noopener noreferrer">
            <span className="sr-only">X</span>
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M4.207 3h5.376l3.498 5.274L17.839 3h5.31l-6.975 8.086L23 21h-5.447l-3.95-5.906L9.254 21H3.941l7.314-8.505L4.207 3zm3.077 2l5.074 7.641L5.552 19h2.618l6.27-7.588L18.52 19H21.4l-6.101-8.874L20.717 5h-2.618l-5.646 6.679L7.22 5H7.284z" />
            </svg>
          </a>
        ...
        <div className="mt-8 border-t border-white/20 pt-8">
          <p className="text-center text-white">© 2025 Chipsub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
